 ...
 */
@Service
public class ${tableName_class}DbAbilityImpl extends AbstractBaseDbAbilityImpl<${tableName_class}> implements I${tableName_class}DbAbility {
